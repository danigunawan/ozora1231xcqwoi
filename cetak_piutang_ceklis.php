...
<table id="tableuser" class="table table-bordered table-sm">
        ...
        $no_urut = 0;
            ...
            $query5 = $db->query("SELECT nama_barang, jumlah_barang, harga,  kode_barang,  asal_satuan, satuan AS id_satuan,  subtotal,satuan.nama AS satuan FROM detail_penjualan INNER JOIN satuan ON detail_penjualan.satuan = satuan.id WHERE no_faktur = '$faktur_kirims' ");
