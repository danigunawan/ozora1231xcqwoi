...
//menampilkan seluruh data yang ada pada tabel pembelian
    ...
    $pembelian_tunai = $ambil_potongan['tunai'];
...
<div class="row">
          ...
          <input type="text" name="pembayaran" id="pembayaran_pembelian" autocomplete="off" style="height:25px;font-size:15px" value="<?php echo $pembelian_tunai; ?>" class="form-control" placeholder="" required="" style="font-size: 20px"></b>
