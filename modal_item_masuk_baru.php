...
<?php
        ...
        $perintah = $db->query("SELECT s.nama,kode_barang,b.nama_barang,b.satuan,b.harga_beli,b.harga_jual,b.harga_jual2,b.harga_jual3,b.stok_barang,b.satuan,b.kategori,b.suplier FROM barang b INNER JOIN satuan s ON b.satuan = s.id WHERE b.status = 'Aktif' AND (b.berkaitan_dgn_stok = 'Barang' || b.berkaitan_dgn_stok = '') ");
