  ...
  // jalankan query
    ...
    while ($data = mysqli_fetch_array($query))
    {
      ...
      if ($data_konversi['harga_konversi'] != 0 || $data_konversi['harga_konversi'] != "") {
        ...
        $query2 = "INSERT INTO detail_retur_penjualan (no_faktur_retur, no_faktur_penjualan, tanggal, nama_barang, kode_barang, jumlah_beli, jumlah_retur, harga, subtotal, potongan, tax, asal_satuan, satuan,jam, nama_konsumen, nama_toko) VALUES ('$data[no_faktur_retur]','$data[no_faktur_penjualan]','$tanggal','$data[nama_barang]','$data[kode_barang]','$data[jumlah_beli]','$jumlah_barang','$harga','$data[subtotal]','$data[potongan]','$data[tax]','$data[satuan_jual]','$data[satuan]','$jam_sekarang','$data[nama_konsumen]','$data[nama_toko]')";
